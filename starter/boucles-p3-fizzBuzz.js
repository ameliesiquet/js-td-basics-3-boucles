...
/*for (let i = 100; i > 0;console.log(i % 15 === 0?`FIZZBUZZ`: i % 5 === 0 ?"FIZZ" :i % 3 === 0 ? "BUZZ":i ), i--) {
}*/


/* demander age, si anné pas valide remettr prompt, mais tant que pas bonne valeur remettre prompt (boucle) */
/*
